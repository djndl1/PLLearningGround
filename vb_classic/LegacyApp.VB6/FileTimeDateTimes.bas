...
Public Property Get UnixEpoch() As FileTimeDateTime
        If s_unixEpoch Is Nothing Then
                Set s_unixEpoch = FromDateTime(1970, 1, 1, 0, 0, 0, 0, UtcKind)
        End If
...
Public Function FromFileTime(ft As FILETIME, Optional dtKind As DateTimeKind = UnspecifiedKind) As FileTimeDateTime
...
Public Function FromSystemTime(sysTime As SYSTEMTIME, Optional dtKind As DateTimeKind = UnspecifiedKind) As FileTimeDateTime
        Dim ft As FILETIME
...
#End If
        Set GetUtcNow = FromFileTime(ft, UtcKind)
End Function
...
#End If
        ...
        Set GetLocalNow = FromFileTime(ft, LocalKind)
End Function
