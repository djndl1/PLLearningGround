...
\tableofcontents %a .toc file will be generated in the first run and will be used in the second run
...
% an optional argument gives a shorter version of the heading used in the TOC
\section[Fonts, Shapes and Styles]{Formatting Fonts, Shapes and Styles}
...
\subsection[Environments]{Using Environments}
